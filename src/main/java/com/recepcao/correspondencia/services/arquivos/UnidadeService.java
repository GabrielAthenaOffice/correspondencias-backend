...
public class UnidadeService {
    private final Map<String, UnidadeInfo> unidades = Map.ofEntries(
            ...
            Map.entry("ATHENA BRASILIA LTDA", new UnidadeInfo("54.790.270/0001-72", "SCS Quadra 01 Bloco L, Sala 905, Brasília, DF")), //
            ...
            Map.entry("ATHENA CUIABA LTDA", new UnidadeInfo("54.734.257/0001-04", "Avenida Historiador Rubens de Mendonça, 1856, Edifício Cuiabá Office Tower, Cuiabá, MT")),
            ...
            Map.entry("ATHENA GOIANIA LTDA", new UnidadeInfo("53.672.579/0001-03", "Avenida República do Líbano, 2341, Goiânia, GO, 74125-904")),
            ...
            Map.entry("ATHENA NATAL LTDA", new UnidadeInfo("50.770.572/0001-28", "Rua DR. Luiz Felipe Camara, 55, Rio Grande do Norte, RN, 59064-200")),
            Map.entry("ATHENA PALMAS LTDA", new UnidadeInfo("54.493.774/0001-20", "Av. Joaquim Teotônio Segurado - Lote 03, conjunto 1 Quadra ACSUSO-10, do Loteamento Palmas.")),
            ...
            Map.entry("ATHENA SAO LUIS LTDA", new UnidadeInfo("54.570.537/0001-16", "Rua das Mitras, 10, São Luís, Maranhão 65075-770")),
